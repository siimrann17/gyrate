  ...
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        /> */}
        <h1 className="bold-52 lg:bold-88">Ride with Gyrate !</h1>
        ...
        <div className="relative z-20 flex w-[368px] flex-col gap-8 rounded-3xl bg-black px-8 py-8">
          <div className="flex flex-col">
            <div className="flexBetween">
              <p className="regular-16 text-white">Enter Date and Time</p>
            ...
            <button className="border-black border-2 bg-white text-black tex t-5l font-bold rounded ">
              Proceed
            </button>
