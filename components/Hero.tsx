...
//       return;
//     }
//     // Navigate to MyRide page with duration as query parameter
//     router.push({
//       pathname: "/MyRide",
...
const Hero =  () => {
  ...
  const scooters = [
    { brand: "Ather 450x", price: 100, speed: 90, image: "/scooters/Ather 450x.jpg" },
    { brand: "Bounce infinite E1", price: 120, speed: 70, image: "/scooters/bounce.jpg" },
    { brand: "Ola s1x", price: 150, speed: 90, image: "/scooters/Ola s1x.jpg" },
    { brand: "Tvs iqube", price: 100, speed: 70, image: "/scooters/Tvs iqube.jpg" },
  ];
