...
//   const handleLoginSignupSuccess = (email) => {
//     setIsLoggedIn(true);
//     setUserEmail(email);
//     closeModal();
//   };
...
//   const handleLoginSignupSuccess = (email: string) => {
//     setIsLoggedIn(true);
//     setCurrentEmail(email); // Set the current email
//     closeModal();
//   };
...
//       {/* Include the modal component */}
//       <LoginSignupModal isOpen={isModalOpen} onClose={closeModal} onSuccess={handleLoginSignupSuccess} />
      
//       {/* Include Profile Modal */}
//       {isProfileModalOpen && (
//         <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
//           <div className="relative bg-white p-8 rounded-lg shadow-lg w-full max-w-md mx-4">
//             {currentEmail === 'pushanag@gmail.com' ? (
//             <AdminProfile onClose={closeProfileModal}/>
//             ) : (
//                <ProfilePage onClose={closeProfileModal}  />
//             )}
...
const Navbar = () => {
  ...
  const handleLoginSignupSuccess = (email: string) => {
    setIsLoggedIn(true);
    localStorage.setItem("currentEmail", email); // Store 
    closeModal();
  };

  const handleLogout = () => {
    setIsLoggedIn(false);
    localStorage.removeItem("currentEmail"); // Remove 
  };
